...
extension UIColor {
    ...
    func fieryOrange() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "FF9500", hexColor2: "FF5E3A")
    }
    
    func blueOcean() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "2BC0E4", hexColor2: "EAECC6")
    }
    
    func deepBlue() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "085078", hexColor2: "85D8CE")
    }
    
    func maceWindu() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "614385", hexColor2: "516395")
    }
    
    func mojitoBlast() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "1D976C", hexColor2: "93F9B9")
    }
    
    func lovelyPink() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "DD5E89", hexColor2: "F7BB97")
    }
    
    func haze() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "8e9eab", hexColor2: "eef2f3")
    }
    
    func beach() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "70e1f5", hexColor2: "ffd194")
    }
    
    func metalic() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "D6CEC3", hexColor2: "E4DDCA")
    }
    
    func orangeMango() -> CAGradientLayer {
        return self.theGradientBackground(hexColor1: "F09819", hexColor2: "EDDE5D")
    }
    
    //MARK: cutomize gradient background
    func theGradientBackground(hexColor1: String, hexColor2:String) -> CAGradientLayer {
